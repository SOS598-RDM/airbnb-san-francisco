...
knitr::include_graphics("img/shutterstock_479816032.jpg")
```
...
Recent developments in San Francisco, CA, USA regarding the growth of Airbnb and its impact on the housing, rental, and hospitality markets require a better understanding of the Airbnb listings. Using data provided by Airbnb, we can explore how Airbnb rentals vary by neighborhood among other relationships.
...
- Note that this URL is specific to San Francisco, CA
